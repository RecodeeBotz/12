...
const banner = 
	CFonts.say(`! ${time2} : ${ucapanWaktu } Loading Script . . .`, {
  font: 'console',
  align: 'left',
})
...
module.exports = { sleep, wait, getBuffer, h2k, generateMessageID, spinner, getGroupAdmins, getRandom, start, info, success, close }
